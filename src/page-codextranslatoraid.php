<?php
/**
 * Template Name: Codex Translator Aid
 *
 * Page template of Codex Translator Aid page. It is assuming child theme of
 * Twenty-Sixteen.
 * With this page template, instantiate the document with the title you want
 * show. If you need just pure html page for Codex translator aid (i:e out of
 * WordPress), then use codextranslatoraid.html
 *
